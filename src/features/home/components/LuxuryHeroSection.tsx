          ...
          {slides.map((slide) => (
            <SwiperSlide key={slide.id}>
              {slide.type === 'outfit' ? (
                ...
                <div className="bg-gradient-to-br from-primary-50  via-amber-50 to-orange-50 flex items-center py-4 md:py-6 overflow-hidden">
                    ...
                    <div className="flex justify-center items-center mb-3 md:mb-4">
                      <div className="relative flex flex-col items-center -space-y-12 md:-space-y-16 w-full max-w-[280px] sm:max-w-sm md:max-w-md px-2">
                        ...
                        <motion.div
                          ...
                          className="absolute -top-10 -right-10 w-32 h-32 md:w-40 md:h-40 bg-primary-500 rounded-full blur-3xl pointer-events-none"
                        />
                        <motion.div
                          initial={{ opacity: 0, scale: 0 }}
                          animate={{ opacity: 0.1, scale: 1 }}
                        ...
                        >
                          ...
                          <motion.div
                            ...
                            className="absolute top-2 left-2 md:top-4 md:left-4 bg-primary-500/90 text-black px-3 py-1.5 md:px-4 md:py-2 rounded-full text-[10px] md:text-sm font-medium shadow-lg"
                          >
                            Stylish Comfort
                          </motion.div>
                        </motion.div>
                ...
                >
                  <div className={`max-w-2xl relative z-50 hero-content ${slide.fullscreen ? 'mx-auto text-center hero-text-overlay' : ''}`}>
                    ...
                    >
                      ...
                      <motion.span 
                        className={`${slide.fullscreen ? 'text-primary-400 text-shadow-lg' : 'text-primary-500'}`}
