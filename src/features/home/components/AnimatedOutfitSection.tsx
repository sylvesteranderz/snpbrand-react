    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute -top-20 -right-20 w-96 h-96 bg-primary-500 rounded-full blur-3xl"
        />
        <motion.div
          initial={{ opacity: 0, scale: 0 }}
          animate={isInView ? { opacity: 0.05, scale: 1 } : {}}
            ...
            >
              <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden aspect-square">
                ...
                <motion.div
                  ...
                  className="absolute top-4 left-4 bg-primary-500/90 text-black px-4 py-2 rounded-full text-xs md:text-sm font-medium"
                >
                  Stylish Comfort
                </motion.div>
              </div>
