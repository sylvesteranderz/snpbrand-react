              ...
              <div className="space-y-4">
                {order.items.map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-lg font-semibold text-price-500">{formatPrice(item.price * item.quantity)}
                    </p>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border sticky top-8">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={handleRefresh}
                  disabled={refreshing}
                  className="w-full btn-outline-primary flex items-center justify-center space-x-2"
                >
