...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 180,
    originalPrice: 200,
    image: '/images/BlackLeather1.jpeg',
  ...
  },
  {
    ...
    name: 'Brown Leather',
    price: 200.00,
    image: '/images/BrownLeather1.png',
...
export const subcategories = {
  slippers: [
    { id: 'male', name: 'Male', count: products.filter(p => p.subcategory === 'male').length },
    { id: 'female', name: 'Female', count: products.filter(p => p.subcategory === 'female').length },
  ],
  apparel: [
    { id: 'quarterneck', name: 'Quarterneck', count: products.filter(p => p.subcategory === 'quarterneck').length },
    { id: 'zipup', name: 'Zip-up', count: products.filter(p => p.subcategory === 'zipup').length },
  ]
}
